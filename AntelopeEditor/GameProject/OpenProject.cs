...
namespace AntelopeEditor.GameProject
{
    ...
    public class ProjectDataList 
    {
     ...
     class OpenProject
     {
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\AntelopeEditor\";
        ...
        private static void ReadProjectData()
        {
            if (File.Exists(_projectDataPath))
            {
                ...
                foreach (var project in projects)
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}{project.ProjectName}\.Antelope\Icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}{project.ProjectName}\.Antelope\Screenshot.png");
                        _projects.Add(project);
                    }
                }
            }
